...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/blue-cloud-f82e)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/blue-cloud-f82e#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-cloud-f82e
```

A live public deployment of this template is available at [https://blue-cloud-f82e.templates.workers.dev](https://blue-cloud-f82e.templates.workers.dev)
